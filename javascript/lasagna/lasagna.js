...
/** 
 *  constant that represents how many minutes the lasagna should be in the oven. It must be exported. 
...
export function preparationTimeInMinutes(numberOfLayers) {
  return Math.floor(PREPARATION_MINUTES_PER_LAYER * numberOfLayers);
}
